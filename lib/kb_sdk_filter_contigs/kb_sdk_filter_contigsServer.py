...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_sdk_filter_contigs'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_sdk_filter_contigs.kb_sdk_filter_contigsImpl import kb_sdk_filter_contigs
impl_kb_sdk_filter_contigs = kb_sdk_filter_contigs(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['kb_sdk_filter_contigs.filter_contigs_async'] = ['kb_sdk_filter_contigs', 'filter_contigs']
async_check_methods['kb_sdk_filter_contigs.filter_contigs_check'] = ['kb_sdk_filter_contigs', 'filter_contigs']
sync_methods['kb_sdk_filter_contigs.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_sdk_filter_contigs'
        ...
        self.rpc_service.add(impl_kb_sdk_filter_contigs.filter_contigs,
                             name='kb_sdk_filter_contigs.filter_contigs',
                             types=[dict])
        self.method_authentication['kb_sdk_filter_contigs.filter_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "kb_sdk_filter_contigs but no authentication header was passed"
                            raise err
